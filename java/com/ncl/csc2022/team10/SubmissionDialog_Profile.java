/**
 * Class Description    : Dialog class which shows up before submitting profile changes
...
public class SubmissionDialog_Profile extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle("Submit changes?")
                .setMessage("All changes submitted must be approved by Admin first, before the changes you made appear on your profile")
